package RaspberryPie_DirectPin_PinPullUp
...
func Invoke(FlowData map[string]interface{}) (flowResult map[string]interface{}, activityResult *context.ActivityContext) {
	...
	if err != nil {
		...
		activityContext.Message = "Rasperry Pi Pin Pull Up : " + err.Error()
		activityContext.ErrorState = activityError
		FlowData["Response"] = "Rasperry Pi Pin Pull Up Failed : " + err.Error()
		logger.Log_ACT(activityContext.Message, logger.Debug, FlowData["InSessionID"].(string))
	} else {
		//setting activityContext property values
		activityContext.ActivityStatus = true
		activityContext.Message = "Rasperry Pi Pin Pull Up completed Successfully!"
		FlowData["Response"] = "Rasperry Pi Pin Pull Up completed Successfully!"
		logger.Log_ACT(activityContext.Message, logger.Debug, FlowData["InSessionID"].(string))
	}
