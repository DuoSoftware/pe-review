package CloudCharge_Upgrade_Custom_Package
...
func Invoke(FlowData map[string]interface{}) (flowResult map[string]interface{}, activityResult *context.ActivityContext) {
	...
	logger.Log_ACT("CloudCharge_Upgrade_Custom_Package", logger.Debug, sessionId)
	...
	if FlowData["Host"] != nil && FlowData["plan"] != nil && FlowData["quantity"] != nil && FlowData["packageAmount"] != nil && FlowData["planDetails"] != nil && FlowData["interval"] != nil && FlowData["securityToken"] != nil && FlowData["token"] != nil && FlowData["panelty"] != nil {
		host = FlowData["Host"].(string)
		host = strings.TrimSpace(host)
		host = strings.TrimSuffix(host, "/")
		completeurl := host + "/duosoftware.paymentgateway.service/stripe/upgrade"

		inputJson["plan"] = FlowData["plan"]
		...
		inputJson["token"] = FlowData["token"]
		inputJson["panelty"] = FlowData["panelty"]
