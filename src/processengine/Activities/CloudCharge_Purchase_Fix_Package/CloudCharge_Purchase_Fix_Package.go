package CloudCharge_Purchase_Fix_Package
...
func Invoke(FlowData map[string]interface{}) (flowResult map[string]interface{}, activityResult *context.ActivityContext) {
	...
	logger.Log_ACT("CloudCharge_Purchase_Fix_Package", logger.Debug, sessionId)
	...
	if FlowData["Host"] != nil && FlowData["token"] != nil && FlowData["plan"] != nil && FlowData["quantity"] != nil && FlowData["amount"] != nil && FlowData["securityToken"] != nil {
		host = FlowData["Host"].(string)
		host = strings.TrimSpace(host)
		host = strings.TrimSuffix(host, "/")
		completeurl := host + "/duosoftware.paymentgateway.service/stripe/fixedPackage"

		inputJson["token"] = FlowData["token"]
		inputJson["plan"] = FlowData["plan"]
		inputJson["quantity"] = FlowData["quantity"]
		inputJson["amount"] = FlowData["amount"]
