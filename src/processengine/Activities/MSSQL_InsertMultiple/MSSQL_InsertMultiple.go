...
func Invoke(FlowData map[string]interface{}) (flowResult map[string]interface{}, activityResult *context.ActivityContext) {
	...
	err := client.GoSmoothFlow(securityToken, namespace, class, settings).StoreObject().WithKeyField(keyProperty).AndStoreOne(objectInterface).Ok()
