package CloudCharge_Purchase_App
...
func Invoke(FlowData map[string]interface{}) (flowResult map[string]interface{}, activityResult *context.ActivityContext) {
	...
	logger.Log_ACT("CloudCharge_Purchase_App", logger.Debug, sessionId)
	...
	if FlowData["Host"] != nil && FlowData["customer"] != nil && FlowData["token"] != nil && FlowData["amount"] != nil && FlowData["appkey"] != nil && FlowData["type"] != nil && FlowData["securityToken"] != nil {
