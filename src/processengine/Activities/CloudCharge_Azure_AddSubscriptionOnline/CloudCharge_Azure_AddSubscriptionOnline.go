package CloudCharge_Azure_AddSubscriptionOnline
...
func Invoke(FlowData map[string]interface{}) (flowResult map[string]interface{}, activityResult *context.ActivityContext) {
	...
	logger.Log_ACT("CloudCharge_Azure_AddSubscriptionOnline", logger.Information, sessionId)
	...
	if FlowData["SubscriptionKey"] != nil && FlowData["email"] != nil && FlowData["planCode"] != nil && FlowData["startDate"] != nil {
		...
		completeurl := "https://cloudcharge.azure-api.net/Subscription-Online/addOnlineSubscription"
