package CloudCharge_Azure_ViewSubscriptionsOffline
...
func Invoke(FlowData map[string]interface{}) (flowResult map[string]interface{}, activityResult *context.ActivityContext) {
	...
	logger.Log_ACT("CloudCharge_Azure_ViewSubscriptionsOffline", logger.Information, sessionId)
	...
	if FlowData["SubscriptionKey"] != nil && FlowData["email"] != nil {
		...
		completeurl := "https://cloudcharge.azure-api.net/Subscription-Offline/getActiveSubscription?email=" + FlowData["email"].(string)
