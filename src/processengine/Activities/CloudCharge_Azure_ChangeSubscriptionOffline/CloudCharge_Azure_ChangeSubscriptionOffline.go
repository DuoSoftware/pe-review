package CloudCharge_Azure_ChangeSubscriptionOffline
...
func Invoke(FlowData map[string]interface{}) (flowResult map[string]interface{}, activityResult *context.ActivityContext) {
	...
	logger.Log_ACT("CloudCharge_Azure_ChangeSubscriptionOffline", logger.Information, sessionId)
	...
	if FlowData["SubscriptionKey"] != nil && FlowData["email"] != nil && FlowData["newplanCode"] != nil && FlowData["oldplanCode"] != nil && FlowData["changeType"] != nil {

		securityToken := FlowData["SubscriptionKey"].(string)

		object := make(map[string]interface{})
		object["email"] = FlowData["email"].(string)
		object["oldplanCode"] = FlowData["oldplanCode"].(string)
		object["newplanCode"] = FlowData["newplanCode"].(string)
		object["changeType"] = FlowData["changeType"].(string)

		if FlowData["note"] != nil {
			object["note"] = FlowData["note"]
		} else {
			object["note"] = ""
		}
		...
		completeurl := "https://cloudcharge.azure-api.net/Subscription-Offline/changeOfflineSubscription"
	...
	if err != nil {
		...
		if !httpActivityResult.ActivityStatus {
			...
			fmt.Println("--------------- Change Subscription Response --------------------")
