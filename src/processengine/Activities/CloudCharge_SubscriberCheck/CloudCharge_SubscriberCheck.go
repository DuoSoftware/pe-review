package CloudCharge_SubscriberCheck
...
func Invoke(FlowData map[string]interface{}) (flowResult map[string]interface{}, activityResult *context.ActivityContext) {
	...
	logger.Log_ACT("CloudCharge_SubscriberCheck", logger.Debug, sessionId)
	...
	if FlowData["Host"] != nil && FlowData["securityToken"] != nil {
		...
		completeurl := host + "/duosoftware.paymentgateway.service/stripe/subscriberCheck"
