package CloudCharge_Register_App
...
func Invoke(FlowData map[string]interface{}) (flowResult map[string]interface{}, activityResult *context.ActivityContext) {
	...
	logger.Log_ACT("CloudCharge_Register_App", logger.Debug, sessionId)
	...
	if FlowData["Host"] != nil && FlowData["uom"] != nil && FlowData["code"] != nil && FlowData["product_name"] != nil && FlowData["category"] != nil && FlowData["price_of_unit"] != nil && FlowData["status"] != nil && FlowData["type"] != nil && FlowData["subscriptionDetails"] != nil && FlowData["securityToken"] != nil {
		...
		inputJson["subscriptionDetails"] = FlowData["subscriptionDetails"]
