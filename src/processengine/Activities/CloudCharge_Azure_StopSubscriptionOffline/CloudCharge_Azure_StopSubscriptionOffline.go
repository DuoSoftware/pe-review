package CloudCharge_Azure_StopSubscriptionOffline
...
func Invoke(FlowData map[string]interface{}) (flowResult map[string]interface{}, activityResult *context.ActivityContext) {
	...
	logger.Log_ACT("CloudCharge_Azure_StopSubscriptionOffline", logger.Information, sessionId)
	...
	if FlowData["SubscriptionKey"] != nil && FlowData["email"] != nil && FlowData["planCode"] != nil && FlowData["changeType"] != nil {
		...
		completeurl := "https://cloudcharge.azure-api.net/Subscription-Offline/stopSubscription"
