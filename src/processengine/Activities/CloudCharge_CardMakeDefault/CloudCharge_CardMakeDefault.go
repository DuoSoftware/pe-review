package CloudCharge_CardMakeDefault
...
func Invoke(FlowData map[string]interface{}) (flowResult map[string]interface{}, activityResult *context.ActivityContext) {
	...
	logger.Log_ACT("CloudCharge_CardMakeDefault", logger.Debug, sessionId)
	...
	if FlowData["Host"] != nil && FlowData["card_id"] != nil && FlowData["securityToken"] != nil {
		host = FlowData["Host"].(string)
		host = strings.TrimSpace(host)
		host = strings.TrimSuffix(host, "/")
		completeurl := host + "/duosoftware.paymentgateway.service/stripe/makeDefault"

		inputJson["card_id"] = FlowData["card_id"]
