package RaspberryPie_DirectPin_PinPullOff
...
func Invoke(FlowData map[string]interface{}) (flowResult map[string]interface{}, activityResult *context.ActivityContext) {
	...
	if err != nil {
		...
		activityContext.Message = "Rasperry Pi Pin Pull Off : " + err.Error()
		activityContext.ErrorState = activityError
		FlowData["Response"] = "Rasperry Pi Pin Pull Off Failed : " + err.Error()
		logger.Log_ACT(activityContext.Message, logger.Debug, FlowData["InSessionID"].(string))
	} else {
		//setting activityContext property values
		activityContext.ActivityStatus = true
		activityContext.Message = "Rasperry Pi Pin Pull Off completed Successfully!"
		FlowData["Response"] = "Rasperry Pi Pin Pull Off completed Successfully!"
		logger.Log_ACT(activityContext.Message, logger.Debug, FlowData["InSessionID"].(string))
	}
