...
func Invoke(FlowData map[string]interface{}) (flowResult map[string]interface{}, activityResult *context.ActivityContext) {
	...
	logger.Log_ACT("CloudCharge_CardAdd", logger.Debug, sessionId)
	...
	if FlowData["Host"] != nil && FlowData["token"] != nil && FlowData["default"] != nil && FlowData["securityToken"] != nil {
		host = FlowData["Host"].(string)
		host = strings.TrimSpace(host)
		host = strings.TrimSuffix(host, "/")
		completeurl := host + "/duosoftware.paymentgateway.service/stripe/cardAdd"

		inputJson["token"] = FlowData["token"]
		inputJson["default"] = FlowData["default"]
