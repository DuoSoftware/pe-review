package CloudDataStore_GetByQuery
...
func Invoke(FlowData map[string]interface{}) (flowResult map[string]interface{}, activityResult *context.ActivityContext) {
	...
	settings["DB_Type"] = "GoogleDataStore"
	settings["type"] = dtype
	...
	data, err := client.GoSmoothFlow(securityToken, namespace, class, settings).GetMany().ByQuerying(query).Ok()
