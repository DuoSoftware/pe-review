package CloudCharge_Upgrade_Fix_Package
...
func Invoke(FlowData map[string]interface{}) (flowResult map[string]interface{}, activityResult *context.ActivityContext) {
	...
	logger.Log_ACT("CloudCharge_Upgrade_Fix_Package", logger.Debug, sessionId)
	...
	if FlowData["Host"] != nil && FlowData["plan"] != nil && FlowData["quantity"] != nil && FlowData["panelty"] != nil && FlowData["securityToken"] != nil {
